@extends('layouts.app')
@section('content')
    <x-breadcrumb link="watch" :value="$video" />
    <div class="mt-4 pb-6">
        <div class="max-w-9xl content-container mx-auto">
            <div class="px-6 md:px-0">
                <h1 class="text-4xl mb-4">{{ $video->title }}</h1>
                @include('partials.video-genre-pills', ['class' => 'border-purple-900 bg-purple-900 text-white md:text-sm'])
            </div>
            <div class="pt-6">
